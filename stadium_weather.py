...
class STADIUM_WEATHER:
    ...
    def parse_weather_forecast(self, soup):
        """
    ...
    def search(self):
        ...
        uid = self.stadium_id[self.stadium]
        # 建構目標 URL
        ...
        data = self.parse_weather_forecast(soup)
        print("Parsed Weather Data:")
        return data
def main():
    weather = STADIUM_WEATHER("臺中洲際棒球場")
    print(weather.data)
